...
public class D0809_Simplify_ExAC_genetable {
	
	/******
	 * 1st, read-in the dataset
	 * 	get the title line
	 * 	split the title line string into an array of strings
	 * 	get the indices for CHROM, POS, AC, AN, CCDS, EXON, PolyPhen, LoF_info, Lof_flags, LoF
	 * 
	 * 2nd, write the key words in the step-1 into a new simplified gene table txt document;
	 * 
	 * 3rd, read-in all other information lines
	 * 	for each line,
	 * 		split the string into arrays
	 * 		get the Chr, Pos, AC, ... info according to the indices we got at step-1
	 * 
	 * 4th, write key information items to the simplified gene table txt document, according to the indic we got in step-1;
	 * @throws IOException 
	 * 
	 */
	...
	public static void main(String[] args) throws IOException{
				...
				File output = new File(routine + "ExAC.allGene.table");
				...
				int index_chrom = -1, index_pos = -1, index_AC = -1, index_AN = -1,  
						index_Poly = -1, index_LoF_flags = -1, index_LoF = -1;
			...
			//	System.out.print("The indice are: CHR " + index_chr +", Position " + index_position +", AC " + index_AC + ", PolyPhen " + index_Poly );
				...
				out_writer.write("CHROM" + "\t" + "POS" + "\t" + "AC" + "\t" + "AN" + "\t" + "PolyPhen" + 
									"\t" + "LoF_flags" + "\t" + "LoF" + "\t" +"AF" + "\n");
				...
				while(read_in.hasNextLine()){
					...
					/****
					System.out.println(varInfo[index_chrom] + "\t" + varInfo[index_pos] + "\t" + varInfo[index_AC] + "\t" 
									+ varInfo[index_AN] + "\t" + varInfo[index_Poly] + "\t"
									+ varInfo[index_LoF_flags] + "\t" + varInfo[index_LoF] + "\t" + AlleleFreq );
							
					System.out.println(index_chrom + "\t" + index_pos + "\t" + index_AC + "\t" + index_AN + "\t" +  index_Poly
												+ "\t" + index_LoF_flags + "\t" + index_LoF + "\n" ); 
					*/
