 ...
 */
public class D0509_Exon_FrameFromCCDS {
	...
	public static void main(String[] args) throws IOException{
		...
		String file_name = "CCDS15.current.txt";
		...
		File output = new File(routine + "/CCDS15_exon_frame_exons.txt");
		...
		while(read_in.hasNextLine()){
			...
			*/
			...
			if(exons.length() > 2){
				 ...
				 * 
				 * so we first delete the [ and ]; the split the number pairs by comma;
