 ...
 * 05-18-2016
 */
public class D0519_Evaluate_max_mutation_sites {
	...
	public static void main(String[] args){
		...
		*/
		...
		for(int i=0; i<total; i++){
			...
			System.out.println( i + " variants, probability: " + Math.pow(10, log_y) + ".\t Combination: " + Combination(total, i) + "\t the probability left: " + (1 -sum));
		}
