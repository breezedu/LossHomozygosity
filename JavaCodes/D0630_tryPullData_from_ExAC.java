 ...
 *
 */
public class D0630_tryPullData_from_ExAC {
	
	public static void main(String[] args) throws InterruptedException, FileNotFoundException {
		
		D0630_tryPullData_from_ExAC pullData_exac = new D0630_tryPullData_from_ExAC();
		...
		System.out.println("There are: " + genes_without_LoF.size() + " genes do not have LoF variants.");
		
		//printout genes without LoF variants
		for(int i=0; i<genes_without_LoF.size(); i++){
			
			System.out.print("\n" + genes_without_LoF.get(i) ); 
		}
		System.out.println();
