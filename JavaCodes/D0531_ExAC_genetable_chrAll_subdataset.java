...
public class D0531_ExAC_genetable_chrAll_subdataset {
	...
	public static void main(String[] args) throws IOException{
		...
		int index_chr = -1, index_position = -1, index_AC = -1, index_Poly = -1, index_LoF = -1;
		...
		System.out.print("The indice are: CHR " + index_chr +", Position " + index_position +", AC " + index_AC + ", PolyPhen " + index_Poly + ", LoF " + index_LoF );
	...
	//	out_writer.write("CHROM" + "\t" + "Position" + "\t" + "AC" + "\t" + "PolyPhen" + "\n");
		...
		while(read_in.hasNextLine()){
			...
			if(!chr_list.contains( varInfo[0] )){
				...
				//2nd, create a buffer writer:
				//save the gene names to a txt document
				String currChr = routine + "/0509/0531_ExAC.gene.chr" + varInfo[0] + ".table";
				...
				out_writer.write("CHROM" + "\t" + "Position" + "\t" + "AC" + "\t" + "PolyPhen" +"\t" + "LoF" + "\n");
				...
				out_writer.write(varInfo[index_chr] + "\t" + varInfo[index_position] + "\t" + varInfo[index_AC] + "\t" + varInfo[index_Poly] + "\t" + varInfo[index_LoF] + "\n");
